 ...
 const tools = [
    {
      ...
      moreInfo: "تتميز هذه النماذج بالقدرة على فهم التفاصيل المعقدة وتحويل الأوامر النصية إلى لوحات فنية فائق الواقعية بدعم من تقنية SynthID للوسم المائي.",
    ...
    },
    {
      ...
      moreInfo: "يعتبر Veo أحدث نموذج من جوجل لتوليد الفيديو، حيث يدعم التناسق البصري الطويل (Cinematic Consistency) ويسمح بالتحكم في زوايا الكاميرا عبر الأوامر النصية.",
    ...
    },
    {
      ...
      moreInfo: "نموذج Lyria يتيح تصميم ترتيبات موسيقية احترافية وكتابة كلمات الأغاني وتوليد أداء صوتي واقعي يتزامن مع المشاهد السينمائية.",
    ...
    },
    {
      ...
      moreInfo: "يستخدم CapCut أدوات الذكاء الاصطناعي لقص المشاهد، إزالة الخلفيات، وتوليد التعليق الصوتي (Text-to-Speech) بدقة عالية.",
    ...
    },
    {
      ...
      moreInfo: "يتم استخدام Gemini Live لإدارة الحوارات المعقدة وتحويل أفكار السيناريو إلى مخططات بصرية (Storyboards) قابلة للتنفيذ.",
      link: "https://gemini.google.com"
    },
    {
      id: 6,
      ...
      moreInfo: "توفير تجربة مستخدم سلسة (SPA) مع تحميل سريع للوسائط المتعددة باستخدام تقنيات Vite المتطورة.",
  ...
  const steps = [
    ...
    { title: "Latent Space", desc: "المعالجة في الفضاء الرقمي لتمثيل المفاهيم بصرياً." },
    { title: "Denoising", desc: "إزالة التشويش تدريجياً للوصول للنتيجة النهائية." }
  ];
  ...
  return (
    <section className="lab-section" id="lab" dir="rtl">
      <div className="container">
        ...
        <p className="section-subtitle">اضغط على الأداة لاستكشاف المزيد حول منهجية العمل</p>
        
        <div className="lab-grid">
          {tools.map((tool) => (
            <div className="lab-card" key={tool.id} onClick={() => setActiveTool(tool)}>
        ...
        {activeTool && (
          <div className="modal-overlay" onClick={() => setActiveTool(null)}>
            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
              ...
              <a href={activeTool.link} target="_blank" rel="noreferrer" className="external-link">
